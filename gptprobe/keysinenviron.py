def keys_in_environ():
    """ Checks that OPEN_AI_KEY_0, OPEN_AI_KEY__1,OPEN_AI_KEY_2 are in environment variables, which is
    a prerequisite to using /openapiwrappers
    
    Side effect: If it finds just OPEN_AI_KEY instead, this will be copied to OPEN_AI_KEY_0, OPEN_AI_KEY__1,OPEN_AI_KEY_2
