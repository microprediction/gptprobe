...
def ask_for_dict_from_text(text, numeric_values_only=False, key_choice=0)->DictOrStr:
    """
    ...
    try:
        ...
        reformatted_response = ask_for_text_from_poorly_formatted_dict_text(text=text, key_choice=key_choice, **open_kwargs)
        try:
